package com.pandaq.ktpanda.requests

import android.text.TextUtils
import com.pandaq.ktpanda.config.CONFIG
import com.pandaq.ktpanda.config.HttpGlobalConfig
import com.pandaq.ktpanda.interceptor.CacheInterceptor
import com.pandaq.ktpanda.interceptor.HeaderInterceptor
import com.pandaq.ktpanda.interceptor.MockDataInterceptor
import com.pandaq.ktpanda.interceptor.TimeoutInterceptor
import com.pandaq.ktpanda.ssl.SSLManager
import com.pandaq.ktpanda.ssl.SSLManager.SafeHostnameVerifier
    ...
    protected val commonRetrofit: Retrofit
        get() {
            ...
            if (!TextUtils.isEmpty(globalConfig.baseUrl)) {
                retrofitBuilder.baseUrl(globalConfig.baseUrl)
            } else {
